let guestList1: string[] = ["Marie Curie", "Oprah Winfrey", "Nelson Mandela"];
console.log(`Original Guest List: ${guestList1}`);

console.log("Good news! I found a bigger dinner table.");

const newGuest1: string = "Ada Lovelace";
const newGuest2: string = "Mahatma Gandhi";
const newGuest3: string = "Steve Jobs";
